...
public class InfoRuta {
    ...
    public InfoRuta(Integer rut_id, String rut_titol, Integer cat_id, String cat_nom, String rut_desc_markdown, Integer rut_desnivell, Integer rut_alcada_max, Integer rut_alcada_min, Float rut_distancia_km, Long rut_temps_aprox, Boolean rut_circular, Integer rut_dificultat_5, String rut_gpx_File_URL, String fot_titol, String fot_url) {
        this.rut_id = rut_id;
