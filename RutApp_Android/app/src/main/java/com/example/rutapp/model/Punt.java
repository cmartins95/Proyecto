...
public class Punt {
    ...
    public Punt(Integer rut_id, Integer pun_numero, String pun_nom, String pun_descripcio, Long pun_hora, Double pun_latitud, Double pun_longitud, Integer pun_elevacio, String fot_titol, String fot_url) {
        this.rut_id = rut_id;
    ...
    public void setRutId(Integer rut_id) {
        this.rut_id = rut_id;
    }
